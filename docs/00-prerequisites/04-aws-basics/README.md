...
> ⚠️ **2025 年 7 月 15 日起,AWS 改版了免費方案的規則**,新舊帳號適用不同制度,務必先確認自己是哪一種:

| 帳號類型 | 制度 | 說明 |
|------|------|------|
| **2025/7/15 (含)後建立的新帳號** | **免費方案 (Free Plan) / 付費方案 (Paid Plan)** | 註冊時二選一。新帳號可獲得 100 美元入帳信用額度,完成特定活動(如使用 EC2、Bedrock)最多再賺 100 美元,合計最多 200 美元,**6 個月內用完或到期即失效**(以先到者為準)。 |
| **2025/7/15 之前建立的舊帳號** | **舊制:12 個月免費 / 永久免費 / 試用** | 沿用以下三種舊分類,不受影響。 |

舊制三種分類(僅適用於 2025/7/15 前建立的帳號):
...
> 不論新舊帳號,**30 多項「永久免費」服務**兩種制度都能用。細節請見 [AWS Free Tier 官方頁面](https://aws.amazon.com/free/) 與 [AWS 官方公告](https://aws.amazon.com/about-aws/whats-new/2025/07/aws-free-tier-credits-month-free-plan/)。
