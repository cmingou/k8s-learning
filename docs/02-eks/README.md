...
| 費用項目 | 計費方式 |
|---|---|
| EC2 On-Demand 節點 | EC2 原價 **+ 約 12% 附加費**(一般機型,AWS 代管節點生命週期費) |
...
>
> **GPU 機型附加費已調降(2026 年 7 月 1 日起)**:AWS 針對 GPU / 加速器機型調降 Auto Mode 管理費——G 系列降 35%、P 系列與 Trainium 降 60%,現有叢集自動套用、免手動調整。上述「約 12%」僅適用一般機型,GPU 機型的實際附加費率更低。詳見 [AWS 公告:Amazon EKS Auto Mode GPU pricing update](https://aws.amazon.com/about-aws/whats-new/2026/07/amazon-eks-auto-mode-gpu-price/)。
