...
> - **[CVE-2026-53031](https://ubuntu.com/security/CVE-2026-53031)**(CVSS 7.8,2026-06-24 揭露):BPF arena(見 2.5 節相關概念)的 `arena_alloc_pages()` 直接收下一個未經檢查的純 `int node_id`,並沿整條記憶體配置鏈往下傳遞,完全沒有邊界檢查。屬於本節分類中的 **maps/helper** 攻擊面。
...
>
> 上述 **CVE-2026-53031/53033/53034/53036/53081/53085/53090** 與下面的 **CVE-2026-53095** 同屬 2026-06-24 同一批公告的核心 BPF 修補,建議一併留意。
...
>
> 上述 **CVE-2026-74612/74616/74665/74589/74710/74714/74715/74720/74700** 為 2026-08-27 公告的同一批修補,加上上面 2026-08-15 那批,兩批合計已超過 25 筆——反映 sockmap、XDP/AF_XDP 資料路徑、conntrack kfunc、驗證器指標追蹤仍是目前這條攻擊面被最頻繁回報問題的幾個區塊。
